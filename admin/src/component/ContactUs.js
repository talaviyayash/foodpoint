...
export default function Category() {
  ...
  const contactUsDetails = async () => {
    const response = await axios.get(
      "https://foodpoint-backend-je3y.onrender.com/api/contactus/all"
    );
  ...
  const deleteMsg = async (id) => {
    const response = await axios.post(
      "https://foodpoint-backend-je3y.onrender.com/api/contactus/delete",
      { id }
    );
  ...
  const sendEmail = async (email) => {
    setSendEmailMsg("");
    const response = await axios.post(
      "https://foodpoint-backend-je3y.onrender.com/api/contactus/email",
      { email, msg: sendEmailMsg }
    );
    console.log(response.data);
    setSendEmailMsg("");
  };
        ...
        <div className="modal-content bg-light p-4 box-shadow">
          ...
          <div className="modal-actions d-flex ms-auto mt-auto">
            <button
              ...
              onClick={() => setDeleteModal({ isvisible: false, id: null })}
            >
              Cancel
            </button>
            <button
              ...
              onClick={() => {
                deleteMsg(deleteModal.id);
                setDeleteModal({ isvisible: false, id: null });
              }}
            >
              Ok
            </button>
        ...
        <div className="model-content-edit bg-light px-4 py-3 box-shadow rounded">
          <p className="fs-5 fw-bold d-flex border-bottom border-2 pb-2 align-items-center">
            ...
            <button
              ...
              onClick={() =>
                setResponseModal({ isvisible: false, id: null, data: null })
              }
            >
          ...
          <div className="mt-3 text-center">
            <button
              ...
              onClick={() => {
                sendEmail(responseModal?.data?.email);
                setResponseModal({ isvisible: false, id: null, data: null });
              }}
            >
              Send
