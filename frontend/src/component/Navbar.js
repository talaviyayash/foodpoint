      ...
      >
        <div className="col d-flex align-items-center">
            ...
            <div className="btn-group dropstart  mb-3">
              ...
              <ul className="dropdown-menu">
                <Link to="/Home" className="text-dark text-decoration-none">
                  <li
                    className="p-2 rounded rounded-3 mx-3 Home"
                    id="Home"
                ...
                <Link to="/Search" className="text-dark text-decoration-none">
                  <li
                    className="p-2 rounded rounded-3 mx-3 Search"
                    id=""
                    onClick={() => changeBgColor()}
                  >
                    Search
                ...
                >
                  <li
                    className="p-2 rounded rounded-3 mx-3 OrderList"
                    id=""
                    onClick={changeBgColor}
                  >
                    Order List
                ...
                >
                  <li
                    className="p-2 rounded rounded-3 mx-3 ContactUs"
                    id=""
                    onClick={() => changeBgColor()}
                  >
                    Help
          ...
          <div className="d-none d-sm-flex">
            ...
            <li className="p-2 rounded rounded-3 mx-3" onClick={logout}>
              Log Out
            </li>
          </div>
        </div>
