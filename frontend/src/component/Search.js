    ...
    if (name.trim() !== "") {
      try {
        const response = await axios.post(
          "https://foodpoint-backend-je3y.onrender.com/api/product/search",
          { name: name.trim() }
        );
        console.log(response.data.product);
        ...
        <div className="" style={{ marginTop: "90px" }}>
          ...
          >
            <div className="container mt-4 px-5  d-flex align-items-center">
              <input
                type="text"
                className="w-100 py-2 px-3 rounded border border-secondary text-center"
              ...
              <div className="container-md px-md-5 mt-4">
                ...
                <div className="row m-0 mb-5 mt-3">
                  ...
                  {searchProduct.map((item, index) => {
                    return (
                      <div className="col-sm-6 px-5-md mb-2" key={index}>
