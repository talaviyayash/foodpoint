...
export default function RestroDetails() {
  ...
  const resturantInfoId = useSelector(
  ...
  const submitDetail = async () => {
    ...
    const response = await axios.post(
      "https://foodpoint-backend-je3y.onrender.com/api/restaurant/update",
      formData,
      {
        headers: {
  ...
  return (
    <>
      {/* <Navbar /> */}
      <h2
        className="py-3 text-center box-shadow position-fixed top-0 w-100"
        ...
        <div className="row mt-5">
          <div className="col-md-3">
            <div className=" px-md-4 d-flex d-md-block justify-content-between">
              <p
                className="py-2 px-3 ps-3 fw-medium border border-2 border-dark rounded rounded-5"
              ...
              <p
                className="py-2 px-3 ps-3 fw-medium border rounded rounded-5"
          ...
          <div className="col-md-9 px-md-4">
            ...
            {changeDetail && (
              <>
                <div
                  className="row mb-5 py-3 px-5 pb-5 m-0 rounded rounded-4"
                  style={{ backgroundColor: "rgb(226, 232, 240)" }}
                >
                  ...
                  <div className="mt-2 m-0">
                    ...
                    <textarea
                      className="w-100 py-1 px-2 border rounded"
                      value={address}
                  ...
                  <div className="row">
                    <div className="col">
                      <div className="mt-2 m-0">
                        ...
                        <input
                          type="text"
                          className="w-100 py-2 px-2 border rounded"
                          value={area}
              ...
              <>
                ...
                >
                  ...
                  <div className="col text-center mt-4">
                    <button
                      className="btn btn-dark mt-3 px-5 fw-bold"
