...
export default function Dashboard() {
  ...
  const dashboardDetails = async () => {
    const response = await axios.get(
      "https://foodpoint-backend-je3y.onrender.com/api/admin/dashboard"
    );
          ...
          <div className="row row2 mb-5">
            <div className="container-fluid mt-5 m-0 p-0 ">
              <div className="container-fluid mt-4 px-3 py-3 m-auto cards">
                ...
                <div className="card text-start">
                  <img
                    src="https://www.svgrepo.com/show/413888/eat.svg"
                    className="img-logo mt-4 ms-3"
                    alt=""
                    style={{ backgroundColor: "rgb(254, 201, 15)" }}
                  />
                  <p className="mt-3 ms-4 fw-bold">
                    {details.ExistsRestaurant}
                  </p>
                ...
                <div className="card text-start">
                  <img
                    src="https://www.svgrepo.com/show/156232/restaurant-table-and-chairs.svg"
                    className="img-logo mt-4 ms-3"
                    alt=""
                ...
                <div className="card text-start">
                  <img
                    ...
                    className="img-logo mt-4 ms-3"
                    alt=""
                    style={{ backgroundColor: "rgb(252, 228, 236)" }}
                  />
                  <p className="mt-3 ms-4 fw-bold">
                    {details.InActiveRestaurant}
                  </p>
                ...
                <div className="card text-start">
                  <img
                    src="https://www.svgrepo.com/show/529189/scooter.svg"
                    className="img-logo mt-4 ms-3"
                    alt=""
                    style={{ backgroundColor: "rgb(232, 234, 246)" }}
                  />
                  <p className="mt-3 ms-4 fw-bold">
                    {details.ExistsDeliveryBoy}
                  </p>
                ...
                <div className="card text-start">
                  <img
                    src="https://www.svgrepo.com/show/521010/truck-speed.svg"
                    className="img-logo mt-4 ms-3"
                    alt=""
                    style={{ backgroundColor: "rgb(252, 228, 236)" }}
                  />
                  <p className="mt-3 ms-4 fw-bold">
                    {details.ActiveDeliveryBoy}
                  </p>
                  <p className="ms-4 font-light-thick">
                    Active Delevery partner
                  </p>
                </div>

                <div className="card text-start">
                  <img
                    src="https://www.svgrepo.com/show/490442/truck-ban.svg"
                    className="img-logo mt-4 ms-3"
                    alt=""
                    style={{ backgroundColor: "rgb(222 220 221)" }}
                  />
                  <p className="mt-3 ms-4 fw-bold">
                    {details.InActiveDeliveryBoy}
                  </p>
                  <p className="ms-4 font-light-thick">
                    Inctive Delevery partner
                  </p>
                </div>

                <div className="card text-start">
                  <img
                    src="https://www.svgrepo.com/show/497852/category.svg"
                    className="img-logo mt-4 ms-3"
                    alt=""
                    style={{ backgroundColor: "rgb(237, 235, 255)" }}
                  />
                ...
                <div className="card text-start">
                  <img
                    ...
                    className="img-logo mt-4 ms-3"
                    alt=""
                    style={{ backgroundColor: "rgb(234, 242, 254)" }}
                  />
                ...
                <div className="card text-start">
                  <img
                    src="https://www.svgrepo.com/show/451289/select-category.svg"
                    className="img-logo mt-4 ms-3"
                    alt=""
                    style={{ backgroundColor: "rgb(255, 252, 224)" }}
                  />
                ...
                <div className="card text-start">
                  <img
                    src="https://www.svgrepo.com/show/496037/category-2.svg"
                    className="img-logo mt-4 ms-3"
                    alt=""
                    style={{ backgroundColor: "rgb(235, 250, 242)" }}
                  />
                  <p className="mt-3 ms-4 fw-bold">
                    {details.ExistsProduct - details.ActiveProduct}
                  </p>
