...
const Home = () => {
  ...
  const getTopRestaurent = async () => {
    try {
      const response = await axios.get(
        "https://foodpoint-backend-je3y.onrender.com/api/Restaurant/toprestaurant"
      );
  ...
  const getTopProduct = async () => {
    try {
      const response = await axios.get(
        "https://foodpoint-backend-je3y.onrender.com/api/product/top"
      );
      // console.log(response.data)
      ...
      <div className="row m-0">
        ...
        >
              ...
              <div className="col d-flex mt-3 scroll-bar py-2">
                {topProduct.map((item, index) => (
                  <div
                    ...
                    className="product ms-3 me-md-5 me-3 text-center  "
                  >
                    <img
                      src={
                        item.img ||
                      ...
                      className="border rounded rounded-circle product-image box-shadow"
                      alt=""
                    />
                    <p className="fs-6 mt-2 text-secondary fw-medium">
                      {item?.name}
                    </p>
                  </div>
                ))}
          ...
          <div className="container-md restaurant mt-5 mb-5">
            <p className="fs-4 text-start fw-bold mb-3">
            ...
            <div className="row m-0">
              ...
              <div className="row  mt-3 mb-5 m-0 ">
                {topRestaurant.map((item, index) => {
                  return (
                    <div
                      className="col-md-4 col-sm-6 col-xs-8 col-12 mb-3 m-auto"
                      onClick={() => {
                    ...
                    >
                      <div className=" m-0 mx-3">
                        ...
                        <div className="px-3 mt-2  w-100">
                          <p className="fs-5 mb-0 fw-medium text-nowrap overflow-hidden">
                            {item?.name}
                          </p>
                          <small className="fw-bold text-secondary mt-1 mb-0">
                            <i className="bi bi-star-fill p-1 py-0 text-light bg-warning rounded rounded-circle" />{" "}
                            {String(item.rating).slice(0, 3)}/5 &#x2022; 20-25
                            mins
                          </small>
                          <br />
                          <p className="fw-medium text-secondary text-nowrap overflow-hidden">
                            &#x2022; {item?.address?.street},{" "}
                            {item?.address?.area}
                          </p>
                        </div>
                ...
                <div className="item p-3 rounded rounded-4 box-shadow">
                  ...
                  <div className="row m-0">
                    <div className="col-8 ">
                      ...
                      <small className="fw-medium">&#x20B9; {item.price}</small>
                      <br />
                      <small className="fw-medium text-secondary">
                        {item.description}.
                      </small>
                    ...
                    <div className="col-4 ">
                      <img
                        ...
                        className="img-fluid rounded rounded box-shadow w-100"
                        alt=""
