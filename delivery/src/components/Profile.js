      ...
      <div className="row m-0 px-4 mb-5">
        ...
        <div className="row mt-3">
          <div className="col-3 ">
            <div className=" px-4">
              <p
                className="py-2 ps-3 fw-medium border border-2 border-dark rounded rounded-5"
              ...
              <p
                className="py-2 ps-3 fw-medium border rounded rounded-5"
                onClick={logout}
                ...
                >
                  ...
                  <div className="row  m-0 mt-3">
                    ...
                    <div
                      ...
                      style={{ backgroundColor: "rgb(231, 236, 242)" }}
                    >
                      <p className=" m-0 py-2">8141235532</p>
                    </div>
                  </div>
                  <div className="row  m-0 mt-3">
                    <div className="col-2 ">
                    ...
                    <div
                      ...
                      style={{ backgroundColor: "rgb(231, 236, 242)" }}
                    >
                      <p className=" m-0 py-2">dhruv@gmail.com</p>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="row mt-2 m-0">
                    ...
                    <div
                      ...
                      style={{ backgroundColor: "rgb(231, 236, 242)" }}
                    >
                      <p className=" m-0 py-2">Malhar Dhosa</p>
                    </div>
                  </div>
                  <div className="row  m-0 mt-3">
                    <div className="col-2 ">
                    ...
                    <div
                      ...
                      style={{ backgroundColor: "rgb(231, 236, 242)" }}
                    >
                      <p className=" m-0 py-2">malhar@gmail.com</p>
                    </div>
                  </div>
                  <div className="row  m-0 mt-3">
                    <div className="col-2 ">
                    ...
                    <div
                      ...
                      style={{ backgroundColor: "rgb(231, 236, 242)" }}
                    >
                      <p className=" m-0 py-2">123, san deresco , filipines</p>
                    </div>
                  </div>
                </div>
