  ...
  const getAllDetail = async () => {
    try {
      const response = await axios.post(
        "https://foodpoint-backend-je3y.onrender.com/api/Restaurant/alldetail",
            ...
            <div className="container-sm px-md-5 w-100 mt-4">
              ...
              <div className="row m-0">
                  ...
                  <div className="">
                    ...
                    <div className="mt-2 mb-1  ">
                      <small className="text-secondary fw-medium">
                        {" "}
                        &#x2022; {restaurantDetails?.timing?.openAt} to{" "}
                        {restaurantDetails?.timing?.closeAt}
                      </small>
                      <br />
                      <small className="text-secondary fw-medium">
                        {" "}
                      ...
                      <br />
                      <p className="text-secondary w-md-75 ps-2">
                        "Experience the essence of culinary excellence at our
                        cozy eatery, where local flavors meet modern flair in
                        every bite, right in the city's heart."
                      </p>
                    </div>
                  </div>
                  <div className="">
                    <div className="border p-2 text-center rounded rounded-3">
                      <p className="mb-0 border-bottom border-2 pb-2 fw-bold">
                        <i className="bi bi-star-fill text-success"></i>{" "}
                        {`${restaurantDetails.rating}`.slice(0, 3)}
                      </p>
                ...
                <div className="col-12 mt-2">
                  <p className="fw-bold">
                    <i className="bi bi-hourglass-split"></i> 20-25 MINS
                  </p>
                </div>
              </div>
              ...
              <div className="row m-0 mt-3">
                <p className="fw-bold text-center">
                  <i className="bi bi-star"> </i> CATEGORIES{" "}
                ...
                <div className="col d-flex py-2 scroll-bar">
                  {categoryData.map((item, index) => {
                    return (
                      <div
                        className="me-4 text-center mx-2 mt-3"
                        style={{ width: "100px" }}
                        key={index}
                        onClick={() => setCategoryId(index)}
                      >
                        <img
                          src="https://media.istockphoto.com/id/962353378/vector/fast-food-line-icon.jpg?s=612x612&w=0&k=20&c=xD9-KlVj_w4hqhlB6VnsnTqcaumATgDnywNdhrhOok4="
                          className="rounded rounded-circle p-1 border box-shadow"
                          alt=""
                          style={{ height: "80px", width: "80px" }}
                        />
                        <br />
                        <small className="mt-2 fw-bold fs-6 text-secondary">
                    ...
                    <div className="col-md-4 col-5 p-0 ">
                      <div className="border mx-3 pb-3 border box-shadow rounded rounded-3 bg-light">
                        <img
                          ...
                          alt=""
                          className="img-fluid w-100 box-shadow rounded rounded-3"
                          style={{ height: "200px", objectFit: "cover" }}
                        />
                        <div className="px-3 mt-2">
                          <div className="px-2">
                            <p className="fs-md-4 fw-bold text-uppercase">
                              {item.name}
                            </p>
                            <p className="mt-1 fs-6 fw-medium">
                              {" "}
                              &#8226; {item.description}
                            </p>
                            <small className="fw-medium text-secondary">
                              <i className="bi bi-star-fill text-secondary">
                                {" "}
                              </i>{" "}
                              {`${item.rating}`.slice(0, 3)}/5
                            </small>
                          </div>
                          <hr className="my-2" />
