  ...
  const sendData = async () => {
    try {
      ...
      const response = await axios.post(
        "https://foodpoint-backend-je3y.onrender.com/api/admin/signup",
        data
      );
                    ...
                    <div className="col border rounded-4 bg-light box-shadow p-3">
                      <form onSubmit={handleSubmit}>
                        ...
                        <div className="row mt-2">
                          ...
                          <div className="d-flex">
                            <p className="text-danger ms-auto me-5">
                              {error.number}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="row d-flex justify-content-center">
                          <button
                            type="submit"
                            className="w-25 mt-2 py-2 btn btn-outline-success"
                            disabled={
                              name === "" ||
                              number === "" ||
                              email === "" ||
