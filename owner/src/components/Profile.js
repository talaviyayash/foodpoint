...
export default function Profile() {
  ...
  const logout = async () => {
    const response = await axios.post(
      "https://foodpoint-backend-je3y.onrender.com/api/logout/logout",
      {},
        ...
        <div className="row mt-3">
          <div className="col-md-3 col-12 ">
            <div className=" px-4 d-md-block d-flex justify-content-evenly">
              <p
                className="py-2 ps-3 pe-3 fw-medium border border-2 border-dark rounded rounded-5"
                onClick={() => setChageDetail(true)}
              >
                Profile
              </p>
              <p
                className="py-2 ps-3 pe-3 fw-medium border border-2 border-dark rounded rounded-5"
                onClick={() => setChageDetail(false)}
              >
                Restaurant
              </p>
              ...
              <p
                className="py-2 ps-3 pe-3 fw-medium border rounded rounded-5"
                onClick={logout}
          ...
          <div className="col-md-9 col-12">
            ...
            {changeDetail && (
              <>
                <div
                  className="row m-0 py-3 border-bottom border-3 border-warning rounded-top rounded-top-4 "
                  style={{ backgroundColor: "rgb(173, 179, 187)" }}
                >
                  <h3>Restaurant Profile</h3>
                </div>

                <div
                  className="row py-1  m-0 rounded-bottom rounded-bottom-4"
                  style={{ backgroundColor: "rgb(226, 232, 240)" }}
                >
                  <div className="row mt-2 m-0">
                    <div className="col-2 ">
                      <p className="fs-5  m-0 py-2">Name</p>
                    </div>
                    <div
                      className="col-7  rounded rounded-2 fw-bold text-secondary"
                      style={{ backgroundColor: "rgb(231, 236, 242)" }}
                    >
                      <p className=" m-0 py-2">{RestaurantInfo.name}</p>
                    </div>
                  </div>
                  <div className="row  m-0 mt-3">
                    <div className="col-2 ">
                      <p className="fs-5  m-0 py-2">Mobile No.</p>
                    </div>
                    <div
                      className="col-7  rounded rounded-2 fw-bold text-secondary"
                      style={{ backgroundColor: "rgb(231, 236, 242)" }}
                    >
                      <p className=" m-0 py-2">{RestaurantInfo.number}</p>
                    </div>
                  </div>
                  <div className="row  m-0 mt-3">
                    <div className="col-2 ">
                      <p className="fs-5  m-0 py-2">Email</p>
                    </div>
                    <div
                      className="col-7  rounded rounded-2 fw-bold text-secondary"
                      style={{ backgroundColor: "rgb(231, 236, 242)" }}
                    >
                      <p className=" m-0 py-2">{RestaurantInfo.email}</p>
                    </div>
                  </div>
                </div>
              </>
            ...
            {!changeDetail && (
              <>
                ...
                >
                  <div className="row mt-2 m-0">
                    <div className="col-2 ">
                      <p className="fs-5  m-0 py-2">Restaurant Name</p>
                    </div>
                    <div
                      className="col-7  rounded rounded-2 fw-bold text-secondary"
                      style={{ backgroundColor: "rgb(231, 236, 242)" }}
                  ...
                  <div className="row  m-0 mt-3">
                    <div className="col-2 ">
                      <p className="fs-5  m-0 py-2">Address</p>
                    </div>
                    <div
                      className="col-7  rounded rounded-2 fw-bold text-secondary"
                      style={{ backgroundColor: "rgb(231, 236, 242)" }}
                    >
                      <p className=" m-0 py-2">
                        ...
                        {RestaurantInfo.address.area}
                      </p>
                    </div>
                  </div>
                  <div className="row  m-0 mt-3">
                    <div className="col-2 ">
                      <p className="fs-5  m-0 py-2">Working Time</p>
                    </div>
                    <div
                      className="col-7  rounded rounded-2 fw-bold text-secondary"
                      style={{ backgroundColor: "rgb(231, 236, 242)" }}
                    >
                      <p className=" m-0 py-2">
                        {RestaurantInfo.timing.openAt} to{" "}
                        {RestaurantInfo.timing.closeAt}
                      </p>
                    </div>
                  </div>
                </div>
