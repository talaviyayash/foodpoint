...
export default function OrderList() {
  // https://foodpoint-backend-je3y.onrender.com/api/order/orderinfo
  ...
  const giveReview = async () => {
    ...
    try {
      const response = await axios.post(
        "https://foodpoint-backend-je3y.onrender.com/api/review/add",
        data
      );
            ...
            <div className="row m-0">
              <div className="container-md px-md-3 p-0 mt-4 ">
                            ...
                            <div className="col ">
                              <div className="row m-0">
                                ...
                                <small className="fw-medium">
                                  Total payment amount : &#x20B9;{item?.total}{" "}
                                </small>
                                <br />
                                <div className="mt-3">
                ...
                {orderPending.length === 0 ? (
                  <div>There Is No Order Runnig To You Right Now.</div>
                ) : (
                  ""
                )}
              </div>
            ...
            <div className="row m-0">
              <div className="container-md px-md-3 p-0 mt-5">
                {orderDone.map((item, index) => {
                  return (
                    <div key={index} className="row m-0 mb-5">
                        ...
                        <div className="item p-sm-3 p-1 rounded rounded-4 box-shadow">
                          <div className="row m-0">
                            <div className="col p-0 p-sm-3">
                              <div className="row m-0">
                                <div className="col d-flex align-items-center">
                                  <div>
                                    <p className="mb-0 fw-bold text-secondary">
                                      By {item?.restaurantDetail?.name}'s
                                    </p>
                                    <small className="fw-medium text-secondary">
                                      <i className="bi bi-star-fill text-secondary">
                                        {" "}
                            ...
                            <div className="col-4 text-center">
                              ...
                              />
                              <p className="mt-2 mb-0 fw-bold text-secondary">
                              ...
                              {!item.isreviewGiven ? (
                                ...
                                <p className="fw-bold text-secondary mb-0">
                                  ...
                                  {String(item?.rating).slice(0, 3)}/5
                                </p>
                              )}
      ...
      <div className="modal-overlay" hidden={!modalState.isVisible}>
        <div className="modal-content bg-light p-4 box-shadow">
          <div className="text-center">
            <img
              src="https://www.svgrepo.com/show/19684/review.svg"
              alt=""
              className="w-25"
            />
