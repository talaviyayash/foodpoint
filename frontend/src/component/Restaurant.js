    ...
    <>
      ...
      <div className="row m-0">
        <div className="container-fluid" style={{ marginTop: "100px" }}>
          <div
            className="container-sm px-md-5 mt-4 w-100"
            style={{ width: "80vw" }}
          >
            {/* RESTAURENT INFO */}
            <div className="row m-0">
              <div className="col-12 d-flex justify-content-between border-bottom ">
                <div className="">
                  ...
                  <span className="fs-4 fw-bold">{restaurantDetails.name}</span>
                  <br />
                  <div className="mt-2 mb-1  ">
                    ...
                    <p className="text-secondary w-md-75 ps-2">
                      "Experience the essence of culinary excellence at our cozy
                      eatery, where local flavors meet modern flair in every
                      bite, right in the city's heart."
                    </p>
                  </div>
                </div>
                <div className="">
                  <div className="border p-2 text-center rounded rounded-3">
                    <p className="mb-0 border-bottom border-2 pb-2 fw-bold">
                      ...
                      {String(restaurantDetails?.rating).slice(0, 3)}
                    </p>
            ...
            <div className="row m-0 ">
              ...
              <div className="col d-flex py-2 scroll-bar">
                {categoryData.map((item, index) => {
                  return (
                    <div
                      className="me-4 text-center mx-2"
                      style={{ width: "100px" }}
                      key={index}
                      ...
                      <div className="row m-0">
                        ...
                        <div className="col-4 ">
                          ...
                          <button
                            ...
                            onClick={() => navigate(`/PlaceOrder/${item._id}`)}
                          >
                            BUY NOW
                          </button>
                        </div>
