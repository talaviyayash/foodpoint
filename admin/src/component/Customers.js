...
export default function Customer() {
  ...
  const getCustomers = async () => {
    const response = await axios.get(
      "https://foodpoint-backend-je3y.onrender.com/api/user/all"
    );
  ...
  const deleteUser = async () => {
    ...
    const response = await axios.post(
      "https://foodpoint-backend-je3y.onrender.com/api/user/delete",
      { User_id }
    );
                            ...
                            return (
                              <tr key={item._id} className="">
                                ...
                                <td className="align-items-center">
                                  <button
                                    className="d-inline btn btn-outline-danger btn-sm me-2"
                                    onClick={() => {
                                      setShowModal(false);
